  ...
  return (
    <section className="px-6 py-32 md:px-24 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        {/* Left: Dynamic 3D Aura Visualization */}
        ...
        {/* Right: Identity & Digital Certificates */}
        <div className="flex-1 space-y-12 text-center lg:text-left">
          ...
          {/* NFT Badge Showcase (Million Dollar Feel) */}
          <div className="space-y-6 px-4 lg:px-0">
            <h3 className="text-xs font-black uppercase tracking-[0.5em] text-white/20">Digital Certificates of Impact</h3>
